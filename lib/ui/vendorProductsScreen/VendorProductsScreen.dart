...
import '/ui/vendorProductsScreen/photos.dart';
import '/ui/vendorProductsScreen/review.dart';

class VendorProductsScreen extends StatefulWidget {
  final VendorModel vendorModel;

  const VendorProductsScreen({Key? key, required this.vendorModel})
      : super(key: key);
...
class _VendorProductsScreenState extends State<VendorProductsScreen>
  ...
  String? foodType, placeHolderImage = "";
  ...
  getProducts() async {
    ...
    lstOfferData =
        fireStoreUtils.getOfferStreamByVendorID(widget.vendorModel.id);
  ...
  void initState() {
    ...
    //   });
    //   print("mylist " + productModel.toList().toString());
    // });
    // });*/
    // });
  ...
  void getFoodType() async {
    ...
    if (foodType == "Takeaway") {
      productsFuture =
          fireStoreUtils.getVendorProductsTakeAWay(widget.vendorModel.id);
    } else {
      productsFuture =
          fireStoreUtils.getVendorProductsDelivery(widget.vendorModel.id);
    }
    productsFuture.then((value) {
      productModel.addAll(value);
                  ...
                  child: Column(
                      ...
                      children: [
                              ...
                              InkWell(
                                  onTap: () {
                                    showModalBottomSheet(
                                      ...
                                      enableDrag: true,
                                      builder: (context) => timeing(context),
                                    );
                                  },
                                  child: Container(
                                    ...
                                    if (snapshot.hasData) {
                                      return
                                        ...
                                        onTap: () => push(
                                          ...
                                          Review(
                                            vendorModel: widget.vendorModel,
                                            reviewlength: snapshot.data!.length
                                                .toString(),
                                          ),
                                        ),
                                        child: Container(
                        ...
                        Builder(builder: (context) {
                          print("product future ${vendorCateoryModel.length}");
                          return StreamBuilder<List<OfferModel>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                if (!snapshot.hasData ||
                                  ...
                                  return Center(
                                    child: Container(
                                      child: Text('No Coupons are Available',
                                          style: TextStyle(
                                            fontFamily: "Poppinsr",
                                            letterSpacing: 0.5,
                                            color: Color(0XFF676771),
                                          ...
                                          return GestureDetector(
                                            onTap: () {
                                              ...
                                              showModalBottomSheet(
                                                ...
                                                enableDrag: true,
                                                builder: (context) =>
                                                    openCouponCode(context,
                                                        snapshot.data![index]),
                                              );
                                            },
                                            child:
                                                buildOfferItem(snapshot, index),
                                          );
                                        }),
                                  );
                                }
                            ...
                            children: [
                              TabBar(
                                  ...
                                  labelStyle: TextStyle(
                                      fontSize: 16, fontFamily: "Poppinsm"),
                                  unselectedLabelStyle:
                                      TextStyle(fontFamily: "Poppinsr"),
                                  labelPadding:
                                        ...
                                        children: [
                                          ...
                                          ListView.builder(
                                            ...
                                            itemBuilder: (context, inx) {
                                              return snapshot.data![inx].categoryID == vendorCateoryModel[index].id && snapshot.data![inx].publish == true ? buildRow(
                                                      snapshot.data![inx],
                                                      veg,
                                                      nonveg,
                                                      snapshot.data![inx]
                ...
                builder: (context, snapshot) {
                  ...
                  if (snapshot.hasData) {
                    snapshot.data!.forEach((element) {
                      ...
                      if ( element.extras_price!=null && !element.extras_price!.isEmpty && double.parse(element.extras_price!)!=0) {
                        total += element.quantity * double.parse(element.extras_price!);
                      } /*else if(!element.extras_price!.isEmpty && element.extras_price!.toString() != "0.0") {
                      ...
                      children: [
                        Row(
                            ...
                            children: [
                              ...
                              Text(symbol + '${total.toDouble().toStringAsFixed(decimal)}',
                                style: TextStyle(
                                    fontFamily: "Poppinsm",
                                    color: Colors.white,
                                    fontSize: 18),
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          "${snapshot.data![index].discountTypeOffer == "Fix Price" ? "\$" : ""}${snapshot.data![index].discountOffer}${snapshot.data![index].discountTypeOffer == "Percentage" ? "% OFF" : " OFF"}",
                          style: TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                          "valid till " +
                              getDate(snapshot.data![index].expireOfferDate!
                                  .toDate()
                                  .toString())!,
                          style: TextStyle(
                              fontSize: 15,
  ...
  buildRow(ProductModel productModel, veg, nonveg, inx) {
    print(productModel.name + " =-=-= " + inx.toString());
    ...
    if (vegSwitch == true && productModel.veg == true) {
      ...
      return cate == 0 ? showEmptyState("", 'No Items are available.') : cate++;
    }
    // else Center();
  }
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: <Widget>[
                        (productModel.disPrice == "" || productModel.disPrice == "0") ? Text(symbol + '${price.toDouble().toStringAsFixed(decimal)}',
                                style: TextStyle(
                                    fontSize: 18,
                                    fontFamily: "Poppinssb",
                                    letterSpacing: 0.5,
                            ...
                            : Column(
                                ...
                                children: [
                                  Text(
                                    symbol +
                                        '${price.toDouble().toStringAsFixed(decimal)}',
                                    style: TextStyle(
                                        fontSize: 15,
                                        fontFamily: "Poppinssb",
                                        letterSpacing: 0.5,
                                  ...
                                  Text(
                                    symbol +
                                        '${double.parse(productModel.disPrice).toDouble().toStringAsFixed(decimal)}',
                                    style: TextStyle(
                                        fontSize: 15,
                                        fontFamily: "Poppinssb",
                                        letterSpacing: 0.5,
                         ...
                         productModel.quantity == 0 ? widget.vendorModel.reststatus != true
                                ? Center()
                                : Padding(
...
*/
    ...
    if (quantity > 1) {
      ...
      if(!isAddSame){
        if (productModel.disPrice != null && productModel.disPrice!.isNotEmpty &&
  ...
  resttiming() {
    // var open = int.parse(widget. vendorModel.opentime);
    // assert(open is int);
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: <TextSpan>[
                  ...
                  TextSpan(
                    text: " & get ${offerModel.discountTypeOffer == "Fix Price" ? "\$" : ""}${offerModel.discountOffer}${offerModel.discountTypeOffer == "Percentage" ? "% off" : " off"} ",
                    style: TextStyle(
                        fontSize: 16.0,
                        color: Colors.grey,
                        fontWeight: FontWeight.w700),
