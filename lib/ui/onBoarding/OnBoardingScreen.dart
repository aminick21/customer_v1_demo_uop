...
class _OnBoardingScreenState extends State<OnBoardingScreen> {
  ...
  final List<String> _subtitlesList = [
    ...
    'Get your favorite item fastest delivered at your doorstep'
        .tr(),
  ];
      ...
      body: Stack(
        children: <Widget>[
          PageView.builder(
           ...
           isDarkMode(context)? _darkimageList[index]:     _imageList[index], _titlesList[index],
          ...
          Visibility(
            ...
            child: Positioned( right: 13,bottom: 17,
            child:
            ...
            child: Align(
              ...
              child: SmoothPageIndicator(
                ...
                effect: ScrollingDotsEffect(
                  spacing: 20,
                    activeDotColor: Color(0XFFFF683A),
         ...
         Visibility(
            ...
            pageController.previousPage(duration: Duration(milliseconds: 100),
               curve: Curves.bounceIn);
            },
              child: 
            Icon(Icons.chevron_left,size: 40,color: isDarkMode(context)? Color(0xffFFFFFF):
              null)
             )),
         ),
         Visibility(
        ...
        Visibility(
          ...
          Positioned( right: 20,top: 40,
            ...
            color:Color(0XFFFF683A),fontFamily: 'Poppinsm'),
            )
          ))),
          Visibility(
            visible: _currentIndex + 1 != _imageList.length,
            child:
          Positioned( right: 13,bottom: 17,
            child:InkWell(onTap: (){},
              child: Container(width: MediaQuery.of(context).size.width*0.94,
            height: MediaQuery.of(context).size.height*0.08,
            ...
            child:
             ElevatedButton(
              style: ElevatedButton.styleFrom(
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(6)),
                primary: Color(0XFFFF683A)
              ),
              child: Text("NEXT".tr(),
              style: TextStyle(fontSize: 16,color: isDarkMode(context)? Color(0xffFFFFFF):
              Color(0XFF333333)),
              ),
            onPressed: (){
  ...
  Widget getPage(dynamic image,_titlesList,
                _subtitlesList,
   ...
   Container(
    //  height:  MediaQuery.of(context).size.height*0.55,
     ...
     decoration: BoxDecoration(color: isDarkMode(context)? Color(0XFF242528):
      Color(0XFFFCEEE9),
       borderRadius:
      BorderRadius.only(bottomLeft:Radius.elliptical(400, 180) ,
     ...
     Container(
      ...
      //         )
              ...
              Text(_titlesList,textAlign: TextAlign.center,
              style: TextStyle(color: isDarkMode(context)?Color(0xffFFFFFF):
              Color(0XFF333333),fontFamily: 'Poppinsm',
              fontSize:20),
              ),
          ...
          child: 
              Text(_subtitlesList,textAlign: TextAlign.center,
              style: TextStyle(color: isDarkMode(context)? Color(0xffFFFFFF):
              Color(0XFF333333),
              fontFamily: 'Poppinsl',height: 2,letterSpacing: 1.2,
              fontSize:15 ),
              )),
