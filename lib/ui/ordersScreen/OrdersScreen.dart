...
import '/ui/orderDetailsScreen/OrderDetailsScreen.dart';
import '/ui/reviewScreen.dart/reviewScreen.dart';
...
class _OrdersScreenState extends State<OrdersScreen> {
            ...
            if (!snapshot.hasData || (snapshot.data?.isEmpty ?? true)) {
              return Center(
                child: showEmptyState(
                    'No Previous Orders'.tr(), 'Let\'s orders item!'.tr()),
              );
            } else {
  ...
  Widget buildOrderItem(OrderModel orderModel) {
    ...
    return Card(
        color: isDarkMode(context) ? Color(0xff35363A) : Color(0xffFFFFFF),
                   ...
                   /* Text(
                    ...
                    InkWell(
                      child: Container(
                          width: MediaQuery.of(context).size.width * 0.4,
                          // height: 50,
                          padding: EdgeInsets.only(top: 8, bottom: 8, left: 40),
                          // primary: Colors.white,
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(5),
                              border: Border.all(
                                  width: 0.8, color: Color(0XFF82807F))),
                          child: Text(
                            'RATE ORDER'.tr(),
                            style: TextStyle(
                                color: isDarkMode(context)
                      ...
                      onTap: () {
                        push(context, ReviewScreen(order: orderModel));
                      },
                    )
                  ],
                )
  ...
  String? getPrice(OrderModel product, int index, CartProduct cartProduct) {
    ...
    var subTotal;
    var price = cartProduct.extras_price == "" || cartProduct.extras_price == null ||  cartProduct.extras_price == "0.0"
            ? 0.0
