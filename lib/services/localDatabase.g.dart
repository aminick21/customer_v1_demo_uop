...
class CartProduct extends DataClass implements Insertable<CartProduct> {
  ...
  factory CartProduct.fromJson(Map<String, dynamic> json,
    ...
    return CartProduct(
      ...
      extras: serializer.fromJson<String?>((json['extras']==null)?"":json['extras'].toString()),
      size: serializer.fromJson<String?>((json['size']==null)?"":json['size'].toString()),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'extras': (extras is String)?serializer.toJson<String?>(extras):serializer.toJson<List<String>>(extras),
  ...
  @override
  int get hashCode => Object.hash(id, name, photo, price, discountPrice,
      vendorID, quantity, extras_price, extras, size);
  @override
